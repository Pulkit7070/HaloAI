      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 w-full max-w-[1400px] mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Experience a new way of working. HaloAI understands your context to help you solve problems and create faster than ever.
          </p>
        </div>
        <div className="flex flex-col md:flex-row justify-center items-center gap-4">
          <Link href="#download-mac" target="_blank" rel="noopener noreferrer">
            <Button
          ...
          <Link href="#download-win" target="_blank" rel="noopener noreferrer">
            <Button
